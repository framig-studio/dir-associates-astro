...
const sliders = [
  {
    ...
    sub_header:
      "Butuh Pengacara Surabaya terbaik atau Pengacara Jakarta terbaik untuk menangani permasalahan hukum Anda? Kami hadir memberikan layanan hukum profesional, responsif, dan terpercaya untuk kebutuhan pribadi maupun perusahaan.",
...
export const homeData = {
  ...
  aboutUs: {
    ...
    description: [
      ...
      "Didukung oleh Tim Pengacara Surabaya dan Jakarta yang terpercaya, serta advokat yang berpengalaman, kami membantu berbagai perkara litigasi maupun non litigasi dengan pendekatan yang strategis dan berorientasi solusi.",
    ],
    cta: {
